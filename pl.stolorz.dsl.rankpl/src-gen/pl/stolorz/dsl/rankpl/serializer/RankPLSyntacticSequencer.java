...
public class RankPLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected RankPLGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (RankPLGrammarAccess) access;
