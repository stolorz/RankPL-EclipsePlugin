...
public class InternalRankPLLexer extends Lexer {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1414:13: ( ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? )
            // InternalRankPL.g:1414:15: ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )?
            {
            // InternalRankPL.g:1414:15: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalRankPL.g:1414:28: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalRankPL.g:1414:32: ( '0' .. '9' )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1416:10: ( 'this one has been deactivated' )
            // InternalRankPL.g:1416:12: 'this one has been deactivated'
            {
    ...
    public final void mRULE_HASH_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1418:19: ( ( '#' ( ( '\\r' )? '\\n' )? | '#' (~ ( ( '#' | '\\n' | '\\r' ) ) )+ ( ( '\\r' )? '\\n' )? | '#' '#' '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? ) )
            // InternalRankPL.g:1418:21: ( '#' ( ( '\\r' )? '\\n' )? | '#' (~ ( ( '#' | '\\n' | '\\r' ) ) )+ ( ( '\\r' )? '\\n' )? | '#' '#' '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            {
            // InternalRankPL.g:1418:21: ( '#' ( ( '\\r' )? '\\n' )? | '#' (~ ( ( '#' | '\\n' | '\\r' ) ) )+ ( ( '\\r' )? '\\n' )? | '#' '#' '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            int alt12=3;
            ...
            switch (alt12) {
                case 1 :
                    // InternalRankPL.g:1418:22: '#' ( ( '\\r' )? '\\n' )?
                    {
                    match('#'); 
                    // InternalRankPL.g:1418:26: ( ( '\\r' )? '\\n' )?
                    int alt5=2;
                    ...
                    break;
                case 2 :
                    // InternalRankPL.g:1418:40: '#' (~ ( ( '#' | '\\n' | '\\r' ) ) )+ ( ( '\\r' )? '\\n' )?
                    {
                    match('#'); 
                    // InternalRankPL.g:1418:44: (~ ( ( '#' | '\\n' | '\\r' ) ) )+
                    int cnt6=0;
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    break;
                case 3 :
                    // InternalRankPL.g:1418:78: '#' '#' '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
                    {
                    match('#'); 
                    match('#'); 
                    match('#'); 
                    // InternalRankPL.g:1418:90: (~ ( ( '\\n' | '\\r' ) ) )*
                    loop9:
                    do {
                        int alt9=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1420:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRankPL.g:1420:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRankPL.g:1420:11: ( '^' )?
            int alt13=2;
            ...
            // InternalRankPL.g:1420:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1422:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRankPL.g:1422:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRankPL.g:1422:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalRankPL.g:1422:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRankPL.g:1422:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop15:
                    do {
                        int alt15=3;
                    ...
                    break;
                case 2 :
                    // InternalRankPL.g:1422:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRankPL.g:1422:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop16:
                    do {
                        int alt16=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1424:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRankPL.g:1424:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRankPL.g:1424:24: ( options {greedy=false; } : . )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1426:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRankPL.g:1426:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRankPL.g:1426:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1428:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRankPL.g:1428:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRankPL.g:1428:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt22=0;
            loop22:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRankPL.g:1430:16: ( . )
            // InternalRankPL.g:1430:18: .
            {
            matchAny(); 
